	...
	<div class="container-fluid">
		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					<li class="active"><a href="#">Apply texts models</a></li>
					<li class="active"><a href="#">Apply full model</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li><a id="exit" href="#"><span class="glyphicon glyphicon-off"></span></a></li>
				</ul>
			</div>
		</nav>
		...
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<!-- <form action="/loading?action=1on1" method="get"> -->
...
$(document).on("click", "#exit", function() { 
    window.location.replace("/jsp/exit.jsp");
	 $.get("/exit");
});
</script>
</html>